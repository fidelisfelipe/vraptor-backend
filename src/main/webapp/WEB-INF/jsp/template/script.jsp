...
<!--Init Javascript -->
	...
	<!-- menus -->
	<script type="text/javascript" src="html/components/vidajs/src/controllers/Menu.js"></script>
	<!-- tabs -->
	<script type="text/javascript" src="html/components/vidajs/src/controllers/TabsSearch.js"></script>
